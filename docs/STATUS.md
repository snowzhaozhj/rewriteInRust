...
- **开放 PR**: PR-5（分支 `feat/m4-orch-01-pr5-real-demo`，[PR #76](https://github.com/snowzhaozhj/rewriteInRust/pull/76)，含 acceptance 文档 + scaffold .gitignore 修复，4 视角审查闭环 + codex 2 important 全修，待用户拍板合并）。**ORCH-01 全 5 PR 落地完毕。**
