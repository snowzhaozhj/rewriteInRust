...
- **进行中 PR [#86](https://github.com/snowzhaozhj/rewriteInRust/pull/86)（收口 #85 三项记账 TODO，2026-07-29，**4 视角审查全闭环、待用户验收**）**：三项均为「说法与实现不符」，其中 ② 含破坏性变更。`just ci` 全绿（基线 809 → **828**，2026-08-01 实测）；远端 CI 5 项全过。
