...
> ⛔ **状态：已被 [MDR-018](018-serial-migration-drop-parallel.md) 取代（2026-07-05）**——迁移工作流回归串行，并行翻译与 worktree 写隔离方案整体废弃。本文件保留作历史记录。
>
> 状态（历史）：已定稿（2026-06-15，用户拍板）。详细执行见 `docs/PLAN-M2.md` §2 D3 / §7 SCALE-02。
