...
| R1-D6-05 | D6 | medium | 04-toolchain.md | 传递性更新深度/环检测/复杂度/退化行为缺失 | reopened | 1 | 3 |
...
| R2-D1-01 | D1 | high | 03-execution-model.md | 意图摘要内容规范缺失，verifier 缺意图一致性维度 | reopened | 2 | 3 |
